...
class Footer extends Page implements IFooter {
  ...
  private createFooter(): void {
    ...
    authors.forEach((el) => {
      ...
      authorsText.setAttribute("target", "_blank");
